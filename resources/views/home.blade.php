        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
                ...
                <div class="group relative p-8 lg:p-10 rounded-[2.5rem] bg-white border border-neutral-100 text-center transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-100 hover:-translate-y-2"
                    ...
                    <div class="flex items-center justify-center gap-1"box-border>
                        <span class="text-5xl font-extrabold text-neutral-900 tracking-tight" x-text="current">0</span>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div class="relative" data-reveal>
                            ...
                            <form x-data="{ name: '', email: '', msg: '', sent: false, submitting: false }"
                                @submit.prevent="submitting=true; setTimeout(() => { sent=true; submitting=false; name=''; email=''; msg='' }, 1500)"
                                class="bg-white rounded-[2.5rem] border border-neutral-100 shadow-xl p-8 sm:p-10 space-y-6">

                                <div class="space-y-2">
                                    <label
                                        class="text-sm font-bold text-neutral-700 uppercase tracking-widest ml-1">Nama</label>
                                    <input x-model="name" type="text" placeholder="Nama Anda"
                                        class="w-full h-14 rounded-2xl border-2 border-neutral-50 bg-neutral-50 px-5 focus:border-indigo-600 focus:bg-white transition-all outline-hidden"
                                        required>
                                </div>

                                <div class="space-y-2">
                                    <label
                                        class="text-sm font-bold text-neutral-700 uppercase tracking-widest ml-1">Email</label>
                                ...
                                <div class="space-y-2">
                                    <label
                                        class="text-sm font-bold text-neutral-700 uppercase tracking-widest ml-1">Pesan</label>
                                    <textarea x-model="msg" rows="4" placeholder="Ceritakan kebutuhan projek Anda..."
                                        class="w-full rounded-2xl border-2 border-neutral-50 bg-neutral-50 p-5 focus:border-indigo-600 focus:bg-white transition-all outline-hidden"
                                        required></textarea>
                                </div>

                                <button type="submit" :disabled="!name || !email || !msg || submitting"
                                    class="w-full h-16 rounded-2xl bg-neutral-900 text-white font-extrabold text-lg flex items-center justify-center gap-3 hover:bg-black transition-all transform active:scale-[0.98] disabled:opacity-50">
                                    <span x-show="!submitting">Kirim Pesan</span>
                                    <svg x-show="submitting" class="animate-spin h-5 w-5" fill="none"
                                        viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10"
                                            stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor"
                                ...
                                <div x-show="sent" x-transition
                                    class="bg-emerald-50 text-emerald-700 p-4 rounded-2xl text-sm font-bold text-center border border-emerald-100">
