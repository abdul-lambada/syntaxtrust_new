        ...
        <div class="card card-rounded">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('admin.promos.create') }}" class="btn btn-primary">Tambah</a>
                </div>
                        ...
                        <tbody>
                            @forelse($items as $i => $s)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.promos.edit', $s) }}" class="btn btn-sm btn-outline-primary">Edit</a>
...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog"><div class="modal-content">
      <div class="modal-header"><h5 class="modal-title">Hapus Promo</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
...
@push('body')
<script>
const modalP = document.getElementById('modalDelete');
modalP?.addEventListener('show.bs.modal', function (event) {
  const b = event.relatedTarget; const id = b.getAttribute('data-id'); const name = b.getAttribute('data-name');
  document.getElementById('delName').textContent = name;
  document.getElementById('delForm').setAttribute('action', `{{ url('admin/promos') }}/${id}`);
});
</script>
@endpush
@endsection
