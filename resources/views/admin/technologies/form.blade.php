    ...
    <div class="col-12">
        <div class="card card-rounded">
            <div class="card-body">
                ...
                <form method="POST" action="{{ $item->exists ? route('admin.technologies.update',$item) : route('admin.technologies.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="icon" value="{{ old('icon', $item->icon) }}" class="form-control" placeholder="class ikon (mdi mdi-code) atau URL">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group" x-data="{ color: '{{ strtoupper(old('color', $item->color ?? '#FFFFFF')) }}' }" x-init="if(!color.startsWith('#')) color = '#' + color">
                                <span class="input-group-text p-0">
                                    <input type="color" x-model="color" class="form-control form-control-color border-0" style="cursor:pointer">
                                </span>
                                <input type="text" name="color" x-model="color" class="form-control" placeholder="#FFFFFF" @input="if(!color.startsWith('#')) color = '#' + color">
                            </div>
