        ...
        <div class="card card-rounded">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title">Proses Kerja</h4>
                    <a href="{{ route('admin.process.create') }}" class="btn btn-primary">Tambah</a>
                </div>
                        ...
                        <tbody>
                            @forelse($items as $i => $s)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.process.edit', $s) }}" class="btn btn-sm btn-outline-primary">Edit</a>
...
modalP?.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('delForm').setAttribute('action', `{{ url('admin/process') }}/${id}`);
});
</script>
@endpush
@endsection
