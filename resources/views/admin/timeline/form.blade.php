...
<div class="row">
    <div class="col-12">
        <div class="card card-rounded">
            <div class="card-body">
                <h4 class="card-title">{{ $item->exists ? 'Edit Timeline Step' : 'Tambah Timeline Step' }}</h4>
                <form method="POST" action="{{ $item->exists ? route('admin.timeline.update',$item) : route('admin.timeline.store') }}">
                    @csrf
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.timeline.index') }}" class="btn btn-light">Batal</a>
                    </div>
                </form>
            </div>
        </div>
